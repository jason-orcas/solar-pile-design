...
def build_report_data() -> ReportData:
    ...
    return ReportData(
        ...
        group_x_spacing=st.session_state.get("group_x_spacing", 36.0),
        group_y_spacing=st.session_state.get("group_y_spacing", 36.0),
        group_piles=st.session_state.get("group_piles", []),
        group_loads=st.session_state.get("group_loads", []),
        group_head_condition=st.session_state.get("group_head_condition", "Free"),
